              ...
              <ul className="menu menu-horizontal px-1 items-center">
                <li>
                  <details>
                    ...
                    <ul className="p-2 bg-black w-[200px]">
                      <li>
                      ...
                      <li>
                        <Link href="/products/storage-device">Storage Device</Link>
                      </li>
                      <li>
                ...
                {/* <li>
                  <Link className="text-center" href="/login"><p>Account <br /><span>Register or Login</span></p></Link>
                </li> */}
                <li className="border rounded-xl ml-2 hover:bg-white hover:text-black transition-all">
